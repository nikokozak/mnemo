...
<div class="border rounded-lg mt-2 mb-4">
    ...
    <div class="p-4">
        ...
        <textarea v-model="contentBlock.fibq_question_text_template" class="w-full text-sm mt-4" placeholder="Anything in {curly} brackets will have to be guessed by the {student}."></textarea>
    </div>
    <!-- End Inner Question -->
